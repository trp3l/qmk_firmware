...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   KC_LGUI, TD(_PRN),          S_CUT,    LT_TAB,   LT_ENT,   RSFT_T(     KC_SPACE),   TD(     COMMA_SCOL  ), KC_RCTRL
                ),
	...
	[_NAGINATA] = LAYOUT(
		...
		_______ , NG_Z,    NG_X,    NG_C,   NG_V,   NG_B,      NG_N,    NG_M,    NG_COMM, NG_DOT,  NG_SLSH, _______,
		             _______ , _______,NG_SHFT2,   LT_TAB,  LT_ENT,    NG_SHFT, _______,_______
		),
	...
	[_S_CUT] = LAYOUT(
	  ...
	  LT(_RAISE,KC_E),  KC_S, 	KC_Z,		KC_Y,		KC_SPACE,	KC_F,		XXXXXXX, KC_LEFT, KC_DOWN, KC_RIGHT,	KC_TAB,		LT(_LOWER,KC_BSPACE),
				 KC_R,  KC_Q,	KC_O,		KC_V,		KC_C,		KC_X,		KC_J,	 KC_H,	  XXXXXXX, KC_SCOLON,   KC_P,	    RGUI_T(KC_SLEP),
							_______ ,KC_W,  		KC_LCTRL,	KC_N,	   KC_ENTER, KC_B,	KC_G, _______
		),
	...
	[_LOWER] = LAYOUT(
			...
			XXXXXXX ,JP_HASH, 	KC_DLR,   KC_LABK,      KC_QUES,		JP_PIPE,	_______ ,_______ ,KC_APP  ,_______ ,_______ ,_______ ,
							 _______ ,KC_RABK,      CTL_T_BS,       LT_TAB,     XXXXXXX,  RSFT_T(KC_SPACE) ,TD(COMMA_SCOL),_______
		),
	...
	[_RAISE] = LAYOUT(
		...
		_______,KC_ENTER, 	KC_F1,	KC_F2,	KC_F3, 	KC_F4,		KC_DOWN,  KC_1,   KC_2,  KC_3,	KC_MINUS,	KC_PERC,
								_______ ,	_______,_______,XXXXXXX,	KC_ENTER, JP_DOT, KC_0,_______
		)

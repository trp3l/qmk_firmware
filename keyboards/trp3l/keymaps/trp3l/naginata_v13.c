...
const PROGMEM naginata_keymap ngmap[] = {
  ...
  // {.key = B_D|B_F|B_K       , .kana = ""},
  // {.key = B_D|B_F|B_L       , .kana = ""},
  {.key = B_D|B_F|B_SCLN    , .kana = SS_LCTRL("k")}, // カタカナ変換
...
const PROGMEM naginata_keymap_long ngmapl[] = {
  ...
  {.key = B_D|B_F|B_U       , .kana = SS_LSFT(SS_TAP(X_END))SS_TAP(X_BSPACE)},
...
// 編集モード2
  ...
  {.key = B_C|B_V|B_O       , .kana = SS_TAP(X_PGDOWN)SS_TAP(X_PGDOWN)SS_TAP(X_PGDOWN)SS_TAP(X_PGDOWN)SS_TAP(X_PGDOWN)},
  ...
  {.key = B_C|B_V|B_J       , .kana = SS_DOWN(X_LSHIFT)SS_TAP(NGLT)SS_TAP(NGLT)SS_TAP(NGLT)SS_TAP(NGLT)SS_TAP(NGLT)SS_UP(X_LSHIFT)},
  {.key = B_C|B_V|B_K       , .kana = SS_DOWN(X_LSHIFT)SS_TAP(NGRT)SS_TAP(NGRT)SS_TAP(NGRT)SS_TAP(NGRT)SS_TAP(NGRT)SS_UP(X_LSHIFT)},
  ...
  {.key = B_C|B_V|B_Y       , .kana = SS_DOWN(X_LSHIFT)SS_LCMD(SS_TAP(NGUP))SS_UP(X_LSHIFT)},
  {.key = B_C|B_V|B_U       , .kana = SS_TAP(NGLT)SS_TAP(NGLT)SS_TAP(NGLT)SS_TAP(NGLT)SS_TAP(NGLT)},
  {.key = B_C|B_V|B_I       , .kana = SS_TAP(NGRT)SS_TAP(NGRT)SS_TAP(NGRT)SS_TAP(NGRT)SS_TAP(NGRT)},
  {.key = B_C|B_V|B_O       , .kana = SS_TAP(X_PGDOWN)SS_TAP(X_PGDOWN)SS_TAP(X_PGDOWN)SS_TAP(X_PGDOWN)SS_TAP(X_PGDOWN)},
  {.key = B_C|B_V|B_P       , .kana = SS_TAP(X_PGUP)SS_TAP(X_PGUP)SS_TAP(X_PGUP)SS_TAP(X_PGUP)SS_TAP(X_PGUP)},
  ...
  {.key = B_C|B_V|B_Y       , .kana = SS_DOWN(X_LSHIFT)SS_LCMD(SS_TAP(NGDN))SS_UP(X_LSHIFT)},
#endif

...
//a連続シフト判定
static bool ex_ngevent     = false;
static bool commonkey_pressed = false;
...
//trp3l
    ...
    switch (ninputs[i]){
		...
		case NG_B:
			break;
		case NG_SHFT2:
			if(!commonkey_pressed){
				ex_ngevent = true;
				commonkey_pressed = false;
			}
			break;
		default:
			commonkey_pressed = true;
			ex_ngevent = false;
			break;
    }
  }

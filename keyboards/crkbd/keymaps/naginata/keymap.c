...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	[_XIN] = LAYOUT(
		LALT_T(KC_ESCAPE),	KC_Q, 		KC_A,	 KC_R,	 KC_D,	   KC_RIGHT,		KC_LEFT, KC_M,	  KC_U,	   KC_P,	KC_Z,		KC_PSCREEN,
		CTL_T(KC_DELETE),	S_CUT_W,	KC_S,	 KC_H,	 KC_T,	   KC_G,			KC_Y,	 KC_I,	  KC_E,	   KC_O,	KC_N,	  	KC_BSPACE,
		LSFT(KC_KPS),   	JP_COLN,	KC_F,	 KC_V,	 KC_C,	   KC_X,			JP_DOT,  KC_L,	  KC_J,	   KC_B,	KC_K,	RWIN_T(KC_SLEP),
								TD(PRN_DANCE), LSFT_T(KC_BSPACE), LT_TAB,			LT_ENTER, RSFT_T(KC_SPACE), TD(COMMA_DANCE)
		),
	...
	[_S_CUT] = LAYOUT(
			KC_ESCAPE,	KC_X,		KC_LSHIFT,	KC_LALT,	KC_C,		KC_D,		KC_Y,	 KC_I,	 KC_UP,   KC_PAUSE,	KC_PSCREEN,	KC_DELETE,
			LT(_RAISE,KC_E),KC_LCTRL,	KC_Z,		KC_Y,		KC_SPACE,	S_TEXT,		XXXXXXX, KC_LEFT, KC_DOWN, KC_RIGHT,	KC_TAB,		LT(_LOWER,KC_BSPACE),
			KC_R,		KC_Q ,		KC_L,		KC_A,		KC_F,		KC_V,		KC_J,	 KC_H,	XXXXXXX, KC_SCOLON,XXXXXXX,_______,
									KC_U,  		KC_S,		KC_N,		KC_ENTER,	KC_B,	_______
		),

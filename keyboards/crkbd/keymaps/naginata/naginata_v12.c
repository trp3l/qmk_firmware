...
//remapez カナのリマップがより簡単にできるようになりました。濁音や外来音に使うかなを右手から左手側（またはその逆）へ移動した場合は濁音定義のL,Rも入れ替えてください。
//Q 小書き
#define KANA_KI B_W
#define KANA_TE B_E
#define KANA_SHI B_R
...
//E 例えば、"く"を右手側に移動する場合、DAK_L を DAK_Rに、HAN_L をHAN_Rに書き換えてください。
